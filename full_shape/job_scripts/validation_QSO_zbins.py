...
def _build_likelihoods_options(stats, tracers, zranges, region, version, stats_dir, project, theory_model,
...
def _build_run_options(stats, tracers, zranges, region, version, stats_dir, project, theory_model,
...
def run_fit(actions=('profile',), template='direct', version='abacus-2ndgen-dr2-complete',
            ...
            stats=['mesh2_spectrum'], tracers=None, zranges=None, region='GCcomb', theory_model='folpsD',
